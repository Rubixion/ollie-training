...
def quarantine(flags):
    """Moves flagged photos out and rewrites manifest + faces.npy; people left without enough() photos become too_few."""
    from collect import enough
